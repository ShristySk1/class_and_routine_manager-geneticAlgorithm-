...
public class Timetable implements Serializable,Comparable<Timetable> {
 ...
 @Column(name = "id")
    ...
    public Timetable(Long id, String seven15eight05, String eight05eight55, String eight55nine45, String nine45ten35, String ten35eleven25, String eleven5twelve15, String twelve15one05, String one5one50, String one50two45, String two45three35, String days, String roomno) {
        this.id = id;
