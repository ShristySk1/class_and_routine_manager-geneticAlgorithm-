 ...
 */
@Controller
@RequestMapping(value = "/admin/edit-table")
public class EditController {
    @Autowired
    private TimetableRepository ttr;

      @Autowired
    private TimetableServiceImpl ttrs;
    ...
    public String edittable(@ModelAttribute TimetableForm timetable) throws SQLException, ClassNotFoundException{
